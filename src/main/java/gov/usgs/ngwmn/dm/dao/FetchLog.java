...
public class FetchLog {
	...
	private static final int PROBLEM_MAX_SIZE = 255;
	/** It seems that MyBatis does not have any magic to limit the size of a String value, so we'll do it here
	 * 
	 * @param problem
	 */
	public void setProblem(String problem) {
		if (problem != null && problem.length() > PROBLEM_MAX_SIZE) {
			problem = problem.substring(0,PROBLEM_MAX_SIZE-8) + "[...]";
		}
