...
public interface FetchLogMapper {
	...
	@Delete({ "delete from GW_DATA_PORTAL.FETCH_LOG",
			"where FETCHLOG_ID = #{fetchlogId,jdbcType=DECIMAL}" })
	...
	@Insert({
			...
			"SPECIFIER)",
			"values (#{fetchlogId,jdbcType=DECIMAL}, #{source,jdbcType=VARCHAR}, ",
			"#{startedAt,jdbcType=TIMESTAMP}, #{status,jdbcType=CHAR}, ",
			"#{problem,jdbcType=VARCHAR}, #{ct,jdbcType=DECIMAL}, #{elapsedSec,jdbcType=FLOAT}, ",
